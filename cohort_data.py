...
def sort_by_cohort(filename):
    ...
    for person_info in data_file:
        person_info = person_info.strip()
        person_info = person_info.split("|")
        if person_info[4] == "Winter 2016":
            winter_16.append(" ".join(person_info[:2]))
        elif person_info[4] == "Spring 2016":
            spring_16.append(" ".join(person_info[:2]))
        elif person_info[4] == "Summer 2016":
            summer_16.append(" ".join(person_info[:2]))
        elif person_info[4] == "Fall 2015":
            fall_15.append(" ".join(person_info[:2]))
        elif person_info[4] == "G":
            ghosts.append(" ".join(person_info[:2]))
